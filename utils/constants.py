...
BO_STATE_CRITICAL_UNPROTECTED = "CRITICAL_UNPROTECTED"
...
VALID_BO_STATES = [
    ...
    BO_STATE_CRITICAL_UNPROTECTED,
]

VALID_TARGET_SL_TYPES = ["points", "percentage", "absolute"]

# Bracket Order Configuration Defaults
BO_DEFAULT_POLL_INTERVAL_SECONDS = 3
BO_DEFAULT_ACTIVE_POLL_INTERVAL_SECONDS = 1
BO_DEFAULT_ENTRY_TIMEOUT_SECONDS = 7200
BO_DEFAULT_SL_RETRY_ATTEMPTS = 3
BO_DEFAULT_RECON_INTERVAL_CYCLES = 5
BO_DEFAULT_MAX_QUOTE_FAILURES = 5
